...
assignValue(t_assign_ternary(GeneralValue,TernaryExpression))  --> word(GeneralValue),
...
ternary(t_ternary(BoolExp,GeneralValue1,GeneralValue2)) --> ["("],boolExp(BoolExp),[")"],[?],word(GeneralValue1),[:],word(GeneralValue2).
...
exp(t_add_horizontal_expression(Expression,VerticalExpression)) --> exp(Expression),
    [+],verticalExp(VerticalExpression).
exp(t_sub_horizontal_expression(Expression,VerticalExpression)) --> exp(Expression),
    [-],verticalExp(VerticalExpression).
exp(t_exp(Expression)) --> verticalExp(Expression).
